public class EmployeeWageBuilder {
    ...
    public EmployeeWageBuilder(String company, int empRatePerHrs, int noOfWorkingDays, int maxHoursPerMonth ) {
...
class EmpWageBuilderArray{
    ...
    private EmployeeWageBuilder [] companyEmpWageArray;

    public EmpWageBuilderArray(){
        companyEmpWageArray =new EmployeeWageBuilder[5];
    }

    public void addCompanyEmpWage(String company,int empRatePerHrs,int noOfWorkingDays,int maxHoursPerMonth){
        companyEmpWageArray[numOFCompany] = new EmployeeWageBuilder(company,empRatePerHrs,noOfWorkingDays,maxHoursPerMonth);
        numOFCompany++;
    }
    ...
    private int computeEmpWage(EmployeeWageBuilder companyEmpWage){
        int empHrs=0;
        int totalEmpHrs=0;
